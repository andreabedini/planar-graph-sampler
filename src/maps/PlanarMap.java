...
public class PlanarMap {
    ...
    /* vertexList contains for each vertex, non incident to the root-edge,
       one of its incident demiArete */
    public DemiAreteList vertexList = new DemiAreteList();
    ...
    public int[] degreeVertices() {
        ...
        for (int i = 0; i < this.vertexList.size(); ++i) {
            ...
            degrees[degree]++;
            if (degree > indexRightMostNonZero) {
                indexRightMostNonZero = degree;
            }
        }
    ...
    public void printHalfEdges() {
        ...
        if (problem > 0) {
            System.out.println("There were " + problem + " problems");
        }
        //if (0==0) return;
    ...
    public void printForBedini(Writer writer) throws IOException {
        ...
        if (problem > 0) {
            System.err.println("There were " + problem + " problems");
        }
        writer.write("\n");
        writer.flush();
    }
