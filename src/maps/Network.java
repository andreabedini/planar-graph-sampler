...
public class Network extends TwoConnectedMap {
    ...
    public void toTwoConnectedMap() {
        ...
        if (this.polesAdjacent() != null) {
            this.removePoleConnectingEdge(e);
        }
    ...
    public DemiArete polesAdjacent() {
        ...
        while (e != this.rootDemiArete) {
            if (DemiArete.belongToSameVertex(e.opp, rootDemiArete.opp)) {
                return e;
            }
            e = e.next;
        }
    ...
    public void removePoleConnectingEdge(DemiArete e) {
        ...
        DemiArete enext = e.next;
        DemiArete eprec = e.prec;
        eprec.next = enext;
        enext.prec = eprec;

        DemiArete eoppnext = e.opp.next;
        DemiArete eoppprec = e.opp.prec;
        eoppprec.next = eoppnext;
        eoppnext.prec = eoppprec;
    ...
    public static Network draw_non_trivial_D(Random r) {
        ...
        if (i == 2) {
            ...
            System.out.println("error in choose vector non trivial D: index= " + i);
            return null;
        }
    }
    ...
    public static Network draw_D(Random r) {
        ...
        if (i == 3) {
            ...
            System.out.println("error in choose vector D: index= " + i);
            return null;
        }
    }
    ...
    public static Network draw_P(Random r) {
        ...
        if (i == 1) {
            return draw_poisson_at_least2_S_plus_H(r);
        } else {
            System.out.println("error in choose vector P: index= " + i);
            return null;
        }
    }
    ...
    public static Network draw_H(Random r) {
        ...
        for (int i = 0; i < core.edgeList.size(); ++i) {
            core.replaceEdgeByNetwork(core.edgeList.getDemiArete(i), trivialNetwork());
        }
        return core;
    }
    ...
    public static Network draw_y_or_P_or_H(Random r) {
        ...
        if (i == 2) {
            ...
            System.out.println("error in choose vector y_or_P_or_H: index= " + i);
            return null;
        }
    }
    ...
    public static Network draw_S_or_H(Random r) {
        ...
        if (i == 1) {
            ...
            System.out.println("error in choose vector S_or_H: index= " + i);
            return null;
        }
    }
    ...
    public static Network draw_dD(Random r) {
        ...
        if (i == 2) {
            ...
            System.out.println("error in choose vector dD: index= " + i);
            return null;
        }
    }
    ...
    public static Network draw_dS(Random r) {
        ...
        if (i == 0) {
            return merge2series(draw_dP_or_dH(r), draw_D(r));
        }
        if (i == 1) {
            return merge2series(draw_y_or_P_or_H(r), draw_D(r));
        }
        if (i == 2) {
            return merge2series(draw_y_or_P_or_H(r), draw_dD(r));
        } else {
            System.out.println("error in choose vector dS: index= " + i);
            return null;
        }
    }
    ...
    public static Network draw_dP(Random r) {
        ...
        if (i == 0) {
            return merge2parallel(trivialNetwork(), merge2parallel(draw_dS_or_dH(r), draw_poisson_S_plus_H(r)));
        }
        if (i == 1) {
            return merge2parallel(draw_dS_or_dH(r), draw_poisson_at_least1_S_plus_H(r));
        } else {
            System.out.println("error in choose vector dP: index= " + i);
            return null;
        }
    }
    ...
    public static Network draw_dH(Random r) {
        ...
        if (c == 0) {
            ...
            for (int i = 0; i < core.edgeList.size(); ++i) {
                core.replaceEdgeByNetwork(core.edgeList.getDemiArete(i), draw_D(r));
            }
            return core;
        }
        if (c == 1) {
            ...
            for (int i = 0; i < core.edgeList.size(); ++i) {
                if (i != j) {
                    ...
                    core.replaceEdgeByNetwork(core.edgeList.getDemiArete(i), draw_dD(r));
                }
            }
            return core;

        } else {
            System.out.println("error in choose vector dH: index= " + c);
            return null;
        }
    }
    ...
    public static Network draw_dP_or_dH(Random r) {
        ...
        if (i == 1) {
            ...
            System.out.println("error in choose vector dP_or_dH: index= " + i);
            return null;
        }
    }
    ...
    public static Network draw_dS_or_dH(Random r) {
        ...
        if (i == 1) {
            ...
            System.out.println("error in choose vector dS_or_dH: index= " + i);
            return null;
        }
    }
    ...
    public static Network draw_ddD(Random r) {
        ...
        if (i == 2) {
            ...
            System.out.println("error in choose vector ddD: index= " + i);
            return null;
        }
    }
    ...
    public static Network draw_ddS(Random r) {
        ...
        if (i == 0) {
            return merge2series(draw_ddP_or_ddH(r), draw_D(r));
        }
        if (i == 1) {
            return merge2series(draw_dP_or_dH(r), draw_D(r));
        }
        if (i == 2) {
            return merge2series(draw_dP_or_dH(r), draw_dD(r));
        }
        if (i == 3) {
            return merge2series(draw_y_or_P_or_H(r), draw_dD(r));
        }
        if (i == 4) {
            return merge2series(draw_y_or_P_or_H(r), draw_ddD(r));
        } else {
            System.out.println("error in choose vector ddS: index= " + i);
            return null;
        }
    }
    ...
    public static Network draw_ddP(Random r) {
        ...
        if (i == 0) {
            return merge2parallel(trivialNetwork(), merge2parallel(draw_ddS_or_ddH(r), draw_poisson_S_plus_H(r)));
        }
        if (i == 1) {
            return merge2parallel(trivialNetwork(), merge2parallel(draw_dS_or_dH(r), merge2parallel(draw_dS_or_dH(r), draw_poisson_S_plus_H(r))));
        }
        if (i == 2) {
            return merge2parallel(draw_ddS_or_ddH(r), draw_poisson_at_least1_S_plus_H(r));
        }
        if (i == 3) {
            return merge2parallel(draw_dS_or_dH(r), merge2parallel(draw_dS_or_dH(r), draw_poisson_S_plus_H(r)));
        } else {
            System.out.println("error in choose vector ddP: index= " + i);
            return null;
        }
    }
    ...
    public static Network draw_ddH(Random r) {
        ...
        if (c == 3) {
            ...
            int j = r.nextInt(core.edgeList.size());
            int m = r.nextInt(core.edgeList.size() - 1);
            if (m >= j) {
                ++m;
            }
            for (int i = 0; i < core.edgeList.size(); ++i) {
            ...
            System.out.println("error in choose vector ddH: index= " + c);
            return null;
        }
    }
    ...
    public static Network draw_ddP_or_ddH(Random r) {
        ...
        if (i == 1) {
            ...
            System.out.println("error in choose vector ddP_or_ddH: index= " + i);
            return null;
        }
    }
    ...
    public static Network draw_ddS_or_ddH(Random r) {
        ...
        if (i == 1) {
            ...
            System.out.println("error in choose vector ddS_or_ddH: index= " + i);
            return null;
        }
    }
}
