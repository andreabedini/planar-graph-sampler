...
public class BinaryTree {
    ...
    public static int countblacknodes = 0;
    public static int countwhitenodes = 0;
    ...
    public static String toString(BinaryTree binaryTree) {
        if (binaryTree == null) {
            ...
            return "(" + toString(binaryTree.leftSon) + toString(binaryTree.rightSon) + ")";
        }
    }
    ...
    public static BinaryTree draw_dxb(Random r) {
        ...
        if (c == 0) {
            ...
            BinaryTree tree = draw_dxu(r);
            BinaryTree.rootNodeOfLastGeneratedTreeBlack = true;
            return tree;
        } else {
            //System.out.println("white");
            BinaryTree tree = draw_dxv(r);
            BinaryTree.rootNodeOfLastGeneratedTreeBlack = false;
            return tree;
        }
    }
    ...
    public static BinaryTree draw_b(Random r) {
        ...
        if (c == 0) {
            // System.out.println("black");
            BinaryTree tree = draw_u(r);
            BinaryTree.rootNodeOfLastGeneratedTreeBlack = true;
            return tree;
        } else {
            // System.out.println("white");
            BinaryTree tree = draw_v(r);
            BinaryTree.rootNodeOfLastGeneratedTreeBlack = false;
            return tree;
        }
    }
