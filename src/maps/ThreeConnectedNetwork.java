...
public class ThreeConnectedNetwork extends Network {
    ...
    public DemiAreteList edgeList = new DemiAreteList();

    // contains for each non-root edge one of its incident demiArete
    /**
    ...
    public void makeCopy(Dart firstDart, Dart rootDart) {
        if (firstDart.associatedDemiArete == null) {
            ...
            if ((dart != rootDart) && (dart.opp != rootDart)) {
                this.vertexList.add(dart.associatedDemiArete);
            }
            ...
            do {
                ...
                if (dart.opp.associatedDemiArete != null) {
                    ...
                    if (dart != rootDart) {
                        this.edgeList.add(dart.associatedDemiArete);
                    }
                }
                dart = dart.next;
            } while (dart != firstDart);
    ...
    public void toScreen() {
        System.out.print("indices of demi-aretes in vertexList: ");
        this.vertexList.toScreen();
        System.out.println("");
        System.out.print("indices of demi-aretes in edgeList: ");
        this.edgeList.toScreen();
        System.out.println("");
        this.vertexList.addAll(this.edgeList);
        System.out.print("indices of merge: ");
        this.vertexList.toScreen();
        System.out.println("");
    }
    ...
    public static ThreeConnectedNetwork draw_K(Random r) {
        while (true) {
            ...
            if (binaryTree != null) {
                ...
                if (dart != null) {
                    return new ThreeConnectedNetwork(dart);
                }
            }
    ...
    public static ThreeConnectedNetwork draw_dxK(Random r) {
        while (true) {
            ...
            int i = BinaryTree.countblacknodes;
            int j = BinaryTree.countwhitenodes;
    ...
    public static ThreeConnectedNetwork draw_dxyK(Random r) {
        ...
        if (c == 0) {
            ...
            while (true) {
                ...
                if (d == 0) {
                    binaryTree = BinaryTree.draw_b(r);
                } else {
                    binaryTree = BinaryTree.draw_dxb(r);
                }
                Dart dart = Dart.closure(binaryTree);
                if (dart != null) {
                    return new ThreeConnectedNetwork(dart);
    ...
    public static ThreeConnectedNetwork draw_dyyK(Random r) {
        ...
        while (true) {
            ...
            if (c == 0) {
                ...
                binaryTree = BinaryTree.draw_dyb(r);
            }
            Dart dart = Dart.closure(binaryTree);
            if (dart != null) {
                return new ThreeConnectedNetwork(dart);
